...
| AionCore build and recovery                 | `5d554c0ae`, `a5811dd39`, `598997cf3`  | accepted/adapted         | AionCore is pinned to `v0.1.44`, database recovery is required at build and startup, and cold managed-resource preparation retries as a bounded fail-closed operation                       |
