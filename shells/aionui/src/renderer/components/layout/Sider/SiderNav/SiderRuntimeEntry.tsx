...
const SiderRuntimeEntry: React.FC<SiderRuntimeEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
  ...
  if (collapsed) {
    return (
      <Tooltip {...siderTooltipProps} content={t('common.tray.runtimeStatus')} position='right'>
        <div
...
export default SiderRuntimeEntry;
