  ...
  it('recursively redacts parseable JSON and adversarial credential patterns without exporting metadata', () => {
    const messages = [
      ...
      textMessage(
        'assistant',
        'left',
        'Basic dXNlcjpwYXNzd29yZA== jwt eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIn0.signature hf_abcdefghijklmnopqrstuvwxyz stripe sk_live_abcdefghijklmnopqrstuvwxyz AWS AKIAIOSFODNN7EXAMPLE GitHub github_pat_abcdefghijklmnopqrstuvwxyz'
      ),
    ];
