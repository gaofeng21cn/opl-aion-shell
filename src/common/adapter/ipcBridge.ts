...
export const shell = {
  ...
  configureOplCodex: bridge.buildProvider<{ exitCode: number; stdout: string; stderr: string }, { apiKey: string }>(
    'shell.configure-opl-codex'
  ), // Configure Codex using stdin-only secret input
