 ...
 *
 * @example
 * getEnvAwareName('.opl-app-data')   // release → '.opl-app-data',   dev → '.opl-app-data-dev'
 * getEnvAwareName('.opl-app-config') // release → '.opl-app-config', dev → '.opl-app-config-dev'
 * // with AIONUI_MULTI_INSTANCE=1:  dev → '.opl-app-data-dev-2'
 */
