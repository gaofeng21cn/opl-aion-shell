...
const POST_INSTALL_SELF_CHECK_PROMPT_DEFAULTS: Record<'zh-CN' | 'en-US', string> = {
  'zh-CN': [
    ...
    '7. 列出 Codex plugin/skill 时统一用短名：MAS、MAG、RCA、OMA、OBF、OPL Flow；不要混用仓库名、长全称和短名。',
    '',
  ...
  'en-US': [
    ...
    '7. When listing Codex plugins or skills, use one short-name style: MAS, MAG, RCA, OMA, OBF, and OPL Flow. Do not mix repository names, long full names, and short names.',
    '',
