...
const WorkspaceCollapse: React.FC<WorkspaceCollapseProps> = ({
  ...
  return (
    <div className={classNames('workspace-collapse min-w-0', className)}>
      ...
      {!siderCollapsed && (
        <div
          className='workspace-collapse__header flex items-center gap-8px h-34px pl-10px pr-8px cursor-pointer hover:bg-fill-3 rd-8px transition-colors min-w-0 group'
          onClick={onToggle}
        >
