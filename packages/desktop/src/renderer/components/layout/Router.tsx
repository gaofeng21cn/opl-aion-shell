...
const PersonalizationSettings = React.lazy(() => import('@renderer/pages/settings/sections/PersonalizationSettings'));
...
const SETTINGS_COMPONENTS = {
  ...
  PersonalizationSettingsContent: PersonalizationSettings,
