...
/**
 * Warning component when OpenClaw channel conflicts with One Person Lab channels
 */
    ...
    <Alert
      ...
      content={
        <Space direction='vertical' size='medium' style={{ width: '100%' }}>
          <Paragraph>
            <Text bold>OpenClaw is handling {platformName} messages, not One Person Lab App.</Text>
          </Paragraph>
          ...
          <Paragraph>
            <Text bold>To use One Person Lab App channels and switch agents:</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <br />
            Then restart OpenClaw and One Person Lab App.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 2: Use a different bot</Text>
            <br />
            Create a new {platformName} bot with different credentials for One Person Lab App.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 3: Keep using OpenClaw</Text>
            <br />
            Disable {platformName} in One Person Lab App channels and continue using OpenClaw's integration.
          </Paragraph>
