...
export type I18nKey =
  ...
  | 'settings.releaseChannels.nightly'
  | 'settings.releaseChannels.stable'
  ...
  | 'settings.runtime.actionQueue'
  | 'settings.runtime.actionResult'
  | 'settings.runtime.actions.dryRun'
  | 'settings.runtime.actions.dryRunComplete'
  | 'settings.runtime.actions.execute'
  | 'settings.runtime.actions.executeComplete'
  | 'settings.runtime.actions.loadDrilldown'
  | 'settings.runtime.actions.loadFull'
  | 'settings.runtime.blockers'
  | 'settings.runtime.decisionMap'
  | 'settings.runtime.description'
  | 'settings.runtime.domainLaneMap'
  | 'settings.runtime.navLabel'
  | 'settings.runtime.ownerBoundary'
  | 'settings.runtime.paperLensRefs'
  | 'settings.runtime.refs'
  | 'settings.runtime.routeGraph'
  | 'settings.runtime.safeActions'
  | 'settings.runtime.sourceSurface'
  | 'settings.runtime.stageGraph'
  | 'settings.runtime.state'
  | 'settings.runtime.taskDrilldown'
  | 'settings.runtime.timeline'
