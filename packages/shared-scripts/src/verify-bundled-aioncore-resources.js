...
const REQUIRED_AIONCORE_VERSION = 'v0.2.1';
const REQUIRED_AIONCORE_REPORTED_VERSION = '0.2.1';
...
function requireManagedDirectCliContract(baseDir, runtimeKey, checked, missing, invalid) {
  ...
  if (
    ...
    codexSource?.oplVerifiedAioncoreVersion !== REQUIRED_OPL_VERIFIED_AIONCORE_VERSION
  ) {
